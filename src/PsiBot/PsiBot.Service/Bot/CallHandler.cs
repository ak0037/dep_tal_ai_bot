...
namespace PsiBot.Services.Bot
{
    ...
    public class CallHandler : HeartbeatHandler
    {
            ...
            : base(TimeSpan.FromMinutes(10), statefulCall?.GraphLogger)
        {
            ...
            this.teamsBot = CreateTeamsBot(this.pipeline, statefulCall.Id);
        ...
        private static ITeamsBot CreateTeamsBot(Pipeline pipeline, string callId)
        {
            return new ParticipantEngagementScaleBot(pipeline, TimeSpan.FromSeconds(1.0 / 15.0), 1920, 1080, true, callId); // Pass callId to ParticipantEngagementScaleBot
        }
